...
public:
	...
	virtual void EventPlayerDisconnectTimedOut( CGamePlayer *player, bool executeTwice = true );
	virtual void EventPlayerDisconnectPlayerError( CGamePlayer *player, bool executeTwice = true );
	virtual void EventPlayerDisconnectSocketError( CGamePlayer *player, bool executeTwice = true );
	virtual void EventPlayerDisconnectConnectionClosed( CGamePlayer *player, bool executeTwice = true );
	virtual void EventPlayerJoined( CPotentialPlayer *potential, CIncomingJoinPlayer *joinPlayer, bool executeTwice = true );
	virtual void EventPlayerJoinedWithScore( CPotentialPlayer *potential, CIncomingJoinPlayer *joinPlayer, double score, bool executeTwice = true );
	virtual void EventPlayerLeft( CGamePlayer *player, uint32_t reason, bool executeTwice = true );
	virtual void EventPlayerLoaded( CGamePlayer *player, bool executeTwice = true );
	virtual void EventPlayerAction( CGamePlayer *player, CIncomingAction *action, bool executeTwice = true );
	virtual void EventPlayerKeepAlive( CGamePlayer *player, uint32_t checkSum, bool executeTwice = true );
	virtual void EventPlayerChatToHost( CGamePlayer *player, CIncomingChatPlayer *chatPlayer, bool executeTwice = true );
	virtual bool EventPlayerBotCommand( CGamePlayer *player, string command, string payload, bool executeTwice = true );
	virtual void EventPlayerChangeTeam( CGamePlayer *player, unsigned char team, bool executeTwice = true );
	virtual void EventPlayerChangeColour( CGamePlayer *player, unsigned char colour, bool executeTwice = true );
	virtual void EventPlayerChangeRace( CGamePlayer *player, unsigned char race, bool executeTwice = true );
	virtual void EventPlayerChangeHandicap( CGamePlayer *player, unsigned char handicap, bool executeTwice = true );
	virtual void EventPlayerDropRequest( CGamePlayer *player, bool executeTwice = true );
	virtual void EventPlayerMapSize( CGamePlayer *player, CIncomingMapSize *mapSize, bool executeTwice = true );
	virtual void EventPlayerPongToHost( CGamePlayer *player, uint32_t pong, bool executeTwice = true );

	// these events are called outside of any iterations

	virtual void EventGameRefreshed( string server, bool executeTwice = true );
	virtual void EventGameStarted( bool executeTwice = true );
	virtual void EventGameLoaded( bool executeTwice = true );
