...
void CGameSlot :: RegisterPythonClass( )
{
	...
	class_<CGameSlot>("gameSlot", no_init)
		...
		.def_readonly("downloadStatus", &CGameSlot::m_DownloadStatus)
		.def_readonly("slotStatus", &CGameSlot::m_SlotStatus)
		.def_readonly("computer", &CGameSlot::m_Computer)
		.def_readonly("team", &CGameSlot::m_Team)
		.def_readonly("colour", &CGameSlot::m_Colour)
		.def_readonly("race", &CGameSlot::m_Race)
		.def_readonly("computerType", &CGameSlot::m_ComputerType)
