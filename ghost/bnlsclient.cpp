...
void CBNLSClient :: RegisterPythonClass( )
{
	...
	class_<CBNLSClient>("BNLSClient", no_init)
		...
		.add_property("socket", make_getter(&CBNLSClient::m_Socket, return_value_policy<reference_existing_object>()))
		.add_property("protocol", make_getter(&CBNLSClient::m_Protocol, return_value_policy<reference_existing_object>()))
