...
void CBNET :: RegisterPythonClass( )
{
	...
	class_<CBNET>("BNET", no_init)
		.add_property("GHost", make_getter(&CBNET::m_GHost, return_value_policy<reference_existing_object>()))
		...
		.def_readonly("OutPackets", &CBNET::m_OutPackets)
		.def_readonly("friends", &CBNET::m_Friends)
		.def_readonly("clans", &CBNET::m_Clans)
		.def_readonly("pairedAdminCounts", &CBNET::m_PairedAdminCounts)
		.def_readonly("pairedAdminAdds", &CBNET::m_PairedAdminAdds)
		.def_readonly("pairedAdminRemoves", &CBNET::m_PairedAdminRemoves)
		...
		.add_property("callableAdminList", make_getter(&CBNET::m_CallableAdminList, return_value_policy<reference_existing_object>()) )
		.add_property("callableBanList", make_getter(&CBNET::m_CallableBanList, return_value_policy<reference_existing_object>()) )
		.def_readonly("admins", &CBNET::m_Admins)
		...
		.def_readonly("CDKeyTFT", &CBNET::m_CDKeyTFT)
		...
		.def("addAdmin", &CBNET::AddAdmin)
		.def("addBan", &CBNET::AddBan)
		.def("removeAdmin", &CBNET::RemoveAdmin)
