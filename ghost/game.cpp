...
void CGame :: EventPlayerAction( CGamePlayer *player, CIncomingAction *action, bool executeTwice )
{
	try	
	{ 
...
bool CGame :: EventPlayerBotCommand( CGamePlayer *player, string command, string payload, bool executeTwice )
{
	try	
	{ 
	...
	bool HideCommand = CBaseGame :: EventPlayerBotCommand( player, command, payload, false );
...
void CGame :: EventGameStarted( bool executeTwice )
{
	try	
	{ 
	...
	CBaseGame :: EventGameStarted( false );
...
void CGame :: RegisterPythonClass( )
{
	...
	class_< CGame, bases<CBaseGame> >("game", no_init)
		.add_property("DBBanLast", make_getter(&CGame::m_DBBanLast, return_value_policy<reference_existing_object>()))
		.def_readonly("DBBans", &CGame::m_DBBans)
		.def_readonly("DBGame", &CGame::m_DBGame)
		.add_property("DBGame", make_getter(&CGame::m_DBGame, return_value_policy<reference_existing_object>()))
		.def_readonly("DBGamePlayers", &CGame::m_DBGamePlayers)
		.add_property("stats", make_getter(&CGame::m_Stats, return_value_policy<reference_existing_object>()))
		.add_property("callableGameAdd", make_getter(&CGame::m_CallableGameAdd, return_value_policy<reference_existing_object>()))
