...
void CBaseGame :: EventPlayerDeleted( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
...
void CBaseGame :: EventPlayerDisconnectTimedOut( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerDisconnectTimedOut", true, boost::ref(this), boost::ref(player)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerDisconnectTimedOut", false, boost::ref(this), boost::ref(player)) 
}

void CBaseGame :: EventPlayerDisconnectPlayerError( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerDisconnectPlayerError", true, boost::ref(this), boost::ref(player)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerDisconnectPlayerError", false, boost::ref(this), boost::ref(player)) 
}

void CBaseGame :: EventPlayerDisconnectSocketError( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerDisconnectSocketError", true, boost::ref(this), boost::ref(player)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerDisconnectSocketError", false, boost::ref(this), boost::ref(player)) 
}

void CBaseGame :: EventPlayerDisconnectConnectionClosed( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerDisconnectConnectionClosed", true, boost::ref(this), boost::ref(player)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerDisconnectConnectionClosed", false, boost::ref(this), boost::ref(player)) 
}

void CBaseGame :: EventPlayerJoined( CPotentialPlayer *potential, CIncomingJoinPlayer *joinPlayer, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerJoined", true, boost::ref(this), boost::ref(potential), boost::ref(joinPlayer)) 
		}
		catch(...) 
		{ 
			return;
...
void CBaseGame :: EventPlayerJoinedWithScore( CPotentialPlayer *potential, CIncomingJoinPlayer *joinPlayer, double score, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerJoinedWithScore", true, boost::ref(this), boost::ref(potential), boost::ref(joinPlayer), score) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerJoinedWithScore", false, boost::ref(this), boost::ref(Player), score) 
}

void CBaseGame :: EventPlayerLeft( CGamePlayer *player, uint32_t reason, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerLeft", true, boost::ref(this), boost::ref(player), reason) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerLeft", false, boost::ref(this), boost::ref(player), reason) 
}

void CBaseGame :: EventPlayerLoaded( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerLoaded", true, boost::ref(this), boost::ref(player)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerLoaded", false, boost::ref(this), boost::ref(player)) 
}

void CBaseGame :: EventPlayerAction( CGamePlayer *player, CIncomingAction *action, bool executeTwice )
{
	if( executeTwice )
	{
		try	
...
void CBaseGame :: EventPlayerKeepAlive( CGamePlayer *player, uint32_t checkSum, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerKeepAlive", true, boost::ref(this), boost::ref(player), checkSum) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerKeepAlive", false, boost::ref(this), boost::ref(player), checkSum) 
}

void CBaseGame :: EventPlayerChatToHost( CGamePlayer *player, CIncomingChatPlayer *chatPlayer, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerChatToHost", true, boost::ref(this), boost::ref(player), boost::ref(chatPlayer)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerChatToHost", false, boost::ref(this), boost::ref(player), boost::ref(chatPlayer)) 
}

bool CBaseGame :: EventPlayerBotCommand( CGamePlayer *player, string command, string payload, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerBotCommand", true, boost::ref(this), boost::ref(player), command, payload) 
		}
		catch(...) 
		{ 
			EXECUTE_HANDLER("PlayerBotCommand", false, boost::ref(this), boost::ref(player), command, payload)
			return false;
		}
...
void CBaseGame :: EventPlayerChangeTeam( CGamePlayer *player, unsigned char team, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerChangeTeam", true, boost::ref(this), boost::ref(player), team) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerChangeTeam", false, boost::ref(this), boost::ref(player), team) 
}

void CBaseGame :: EventPlayerChangeColour( CGamePlayer *player, unsigned char colour, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerChangeColour", true, boost::ref(this), boost::ref(player), colour) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerChangeColour", false, boost::ref(this), boost::ref(player), colour) 
}

void CBaseGame :: EventPlayerChangeRace( CGamePlayer *player, unsigned char race, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerChangeRace", true, boost::ref(this), boost::ref(player), race) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerChangeRace", false, boost::ref(this), boost::ref(player), race) 
}

void CBaseGame :: EventPlayerChangeHandicap( CGamePlayer *player, unsigned char handicap, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerChangeHandicap", true, boost::ref(this), boost::ref(player), handicap) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerChangeHandicap", false, boost::ref(this), boost::ref(player), handicap) 
}

void CBaseGame :: EventPlayerDropRequest( CGamePlayer *player, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerDropRequest", true, boost::ref(this), boost::ref(player)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerDropRequest", false, boost::ref(this), boost::ref(player)) 
}

void CBaseGame :: EventPlayerMapSize( CGamePlayer *player, CIncomingMapSize *mapSize, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerMapSize", true, boost::ref(this), boost::ref(player), boost::ref(mapSize)) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerMapSize", false, boost::ref(this), boost::ref(player), boost::ref(mapSize)) 
}

void CBaseGame :: EventPlayerPongToHost( CGamePlayer *player, uint32_t pong, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("PlayerPongToHost", true, boost::ref(this), boost::ref(player), pong) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("PlayerPongToHost", false, boost::ref(this), boost::ref(player), pong) 
}

void CBaseGame :: EventGameRefreshed( string server, bool executeTwice )
{
	if( executeTwice )
	{
		try	
		{ 
			EXECUTE_HANDLER("GameRefreshed", true, boost::ref(this), server) 
		}
		catch(...) 
		{ 
			return;
	...
	if( executeTwice )
		EXECUTE_HANDLER("GameRefreshed", false, boost::ref(this), server)  
}

void CBaseGame :: EventGameStarted( bool executeTwice )
{
	if( executeTwice )
	{
		try	
...
void CBaseGame :: EventGameLoaded( bool executeTwice )
{
	if( executeTwice )
	{
		try	
...
void CBaseGame :: RegisterPythonClass( )
{
	...
	class_<CBaseGame>("baseGame", no_init)
		.add_property("GHost", make_getter(&CBaseGame::m_GHost, return_value_policy<reference_existing_object>()))

		.add_property("socket", make_getter(&CBaseGame::m_Socket, return_value_policy<reference_existing_object>()))
		.add_property("protocol", make_getter(&CBaseGame::m_Protocol, return_value_policy<reference_existing_object>()))
		...
		.add_property("map", make_getter(&CBaseGame::m_Map, return_value_policy<reference_existing_object>()))
		.add_property("saveGame", make_getter(&CBaseGame::m_SaveGame, return_value_policy<reference_existing_object>()))
		.add_property("replay", make_getter(&CBaseGame::m_Replay, return_value_policy<reference_existing_object>()))
